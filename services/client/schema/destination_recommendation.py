...
class DestinationRecommendation(PartialValidationMixin, BaseModel):
    ...
    trip_start: Annotated[date, Field(..., description="Expected start date of the trip. Infer using date interpretation rules, if not provided")]
    trip_end: Annotated[date, Field(..., description="Expected end date of the trip. Infer using date interpretation rules, if not provided")]
